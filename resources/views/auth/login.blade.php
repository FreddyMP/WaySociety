...
@section('meta_description', 'Accede a tu cuenta WaySociety y conecta con el futuro empresarial.')
    ...
    <div class="auth-card">
        ...
        <form action="{{ route('login') }}" method="POST" id="loginForm">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="••••••••"
                        autocomplete="current-password" required style="padding-left:2.5rem;padding-right:2.75rem;">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.5rem;">
                <label
                    style="display:flex;align-items:center;gap:0.5rem;cursor:pointer;font-size:0.83rem;color:var(--white-soft);">
        ...
        <div style="text-align:center;">
            <p style="font-size:0.85rem;color:var(--white-soft);">
                ¿No tienes cuenta?
                <a href="{{ route('register') }}" style="color:var(--gold);font-weight:600;transition:color 0.2s;"
