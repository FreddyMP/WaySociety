...
<head>
    ...
    <title>@yield('title', 'Dashboard') — INVESTA</title>
    <meta name="description" content="@yield('meta_description', 'Panel de control INVESTA')">
...
<div class="layout-auth">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-logo">
            ...
            <div>
                <div class="sidebar-logo-text">INVESTA</div>
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('notifications.index') }}"
               class="sidebar-link {{ request()->routeIs('notifications.*') ? 'active' : '' }}" id="sidebarNotifLink">
            ...
            <form action="{{ route('logout') }}" method="POST" style="margin:0;">
                @csrf
                <button type="submit" class="sidebar-link" style="width:100%;background:none;text-align:left;border:none;border-left:3px solid transparent;">
            ...
            <a href="{{ route('profile.edit') }}" class="sidebar-user">
                ...
                <div style="min-width:0;">
                    ...
                    <div class="sidebar-user-role">
                        <i class="fas {{ auth()->user()->isEntrepreneur() ? 'fa-rocket' : 'fa-chart-pie' }}" style="font-size:0.6rem;"></i>
                        {{ auth()->user()->isEntrepreneur() ? 'Emprendedor' : 'Inversionista' }}
                    </div>
                </div>
                <i class="fas fa-chevron-right" style="color:var(--white-dim);font-size:0.7rem;margin-left:auto;flex-shrink:0;"></i>
            </a>
        </div>
    </aside>
    ...
    <div class="main-content">
        ...
        <header class="navbar">
            ...
            <div class="navbar-right">
                <a href="{{ route('notifications.index') }}" class="navbar-icon-btn" id="navbarNotifBtn" title="Notificaciones">
                ...
                <a href="{{ route('profile.edit') }}" class="navbar-profile" id="navbarProfile">
                    ...
                    <div>
                        ...
                        <div class="navbar-profile-role">{{ auth()->user()->isEntrepreneur() ? 'Emprendedor' : 'Inversionista' }}</div>
                    </div>
